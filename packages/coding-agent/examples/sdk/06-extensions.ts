 ...
 * - ~/.worx/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.worx/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.worx/agent/extensions/ or .worx/extensions/
