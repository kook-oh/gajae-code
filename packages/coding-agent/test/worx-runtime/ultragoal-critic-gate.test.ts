...
import { verifyUltragoalDurableCompletionState } from "@bworx-io/worx-code/worx-runtime/ultragoal-guard";
import {
...
} from "@bworx-io/worx-code/worx-runtime/ultragoal-receipt-freshness";
import {
	appendLedger,
...
beforeEach(() => {
	...
	process.env.CI_DEV_CHANGED_PATHS = "packages/coding-agent/test/worx-runtime/ultragoal-critic-gate.test.ts";
});
