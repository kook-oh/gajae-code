...
import { sessionUltragoalDir } from "@bworx-io/worx-code/worx-runtime/session-layout";
import {
	type UltragoalGuardState,
	validateCompletionReceipt,
	verifyUltragoalDurableCompletionState,
} from "@bworx-io/worx-code/worx-runtime/ultragoal-guard";
import { computeUltragoalPlanGeneration } from "@bworx-io/worx-code/worx-runtime/ultragoal-receipt-freshness";
import {
	addUltragoalSubgoal,
...
beforeEach(() => {
	...
	process.env.CI_DEV_CHANGED_PATHS =
		"packages/coding-agent/test/worx-runtime/ultragoal-durable-completion-release.test.ts";
});
