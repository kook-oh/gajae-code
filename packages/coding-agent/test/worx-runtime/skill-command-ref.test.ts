...
import { renderCommandRefBlock } from "@bworx-io/worx-code/worx-runtime/workflow-command-ref";
...
const skillFiles = CANONICAL_WORX_WORKFLOW_SKILLS.map(skill =>
	path.join(repoRoot, "packages", "coding-agent", "src", "defaults", "worx", "skills", skill, "SKILL.md"),
);
