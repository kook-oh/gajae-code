 ...
 * brush spawn). This test pulls the fix end-to-end through the GJC coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the GJC host process.
 */
...
import { createMockModel, type MockResponse } from "@bworx-io/worx-ai/providers/mock";
