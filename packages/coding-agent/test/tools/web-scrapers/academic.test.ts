...
import { handleArxiv } from "@bworx-io/worx-code/web/scrapers/arxiv";
import { handleIacr } from "@bworx-io/worx-code/web/scrapers/iacr";
import { handlePubMed } from "@bworx-io/worx-code/web/scrapers/pubmed";
import { handleSemanticScholar } from "@bworx-io/worx-code/web/scrapers/semantic-scholar";
import type { RenderResult } from "@bworx-io/worx-code/web/scrapers/types";
