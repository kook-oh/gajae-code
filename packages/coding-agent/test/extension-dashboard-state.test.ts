...
import { applyDisabledExtensionsToState } from "@bworx-io/worx-code/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@bworx-io/worx-code/modes/components/extensions/types";
