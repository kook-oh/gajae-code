 ...
 * can dedupe `@bworx-io/worx-code-natives` declarations by package ID to an older
 ...
 * them.
 */
import "@bworx-io/worx-code-natives";

declare module "@bworx-io/worx-code-natives" {
