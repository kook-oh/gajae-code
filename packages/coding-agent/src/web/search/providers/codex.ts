...
import { type AuthStorage, getBundledModels } from "@bworx-io/worx-ai/core";
import { decodeJwt } from "@bworx-io/worx-ai/utils/oauth/openai-codex";
...
function getConfiguredModel(): string | undefined {
	const configuredModel = ($env.WORX_OPENAI_CODE_WEB_SEARCH_MODEL ?? $env.PI_CODEX_WEB_SEARCH_MODEL)?.trim();
