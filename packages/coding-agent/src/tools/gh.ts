...
import { getWorktreeDir, hashPath, isEnoent, prompt, untilAborted } from "@bworx-io/worx-utils";
...
const PR_CHECKOUT_BRANCH_CONFIG = {
	headRef: "worxPrHeadRef",
	url: "worxPrUrl",
	isCrossRepository: "worxPrIsCrossRepository",
	maintainerCanModify: "worxPrMaintainerCanModify",
} as const;
...
const PR_CREATE_BASE_CONFIG_KEYS = ["github.prBase", "gh.prBase", "worx.github.prBase"] as const;
