...
import type { applyBashFixups as applyBashFixupsFn } from "@bworx-io/worx-code-natives";
...
function applyBashFixupsNative(command: string): ReturnType<typeof applyBashFixupsFn> {
	nativeApplyBashFixups ??= (require("@bworx-io/worx-code-natives") as { applyBashFixups: typeof applyBashFixupsFn })
		.applyBashFixups;
