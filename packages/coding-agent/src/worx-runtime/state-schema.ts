...
const CANONICAL_WORX_WORKFLOW_SKILLS = ["deep-interview", "ralplan", "ultragoal", "team"] as const;
const skillEnum = z.enum([...CANONICAL_WORX_WORKFLOW_SKILLS]);
const ownerEnum = z.enum(["worx-state-cli", "worx-runtime", "worx-hook"]);
