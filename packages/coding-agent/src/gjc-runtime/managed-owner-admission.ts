...
const MANAGED_OWNER_GENERATION_ENV = "WORX_TMUX_OWNER_GENERATION";
const MANAGED_OWNER_INCARNATION_ENV = "WORX_MANAGED_OWNER_INCARNATION";
const MANAGED_OWNER_RUN_ID_ENV = "WORX_MANAGED_OWNER_RUN_ID";
const MANAGED_OWNER_SESSION_ID_ENV = "WORX_COORDINATOR_SESSION_ID";
const MANAGED_OWNER_STATE_DIR_ENV = "WORX_TMUX_OWNER_STATE_DIR";

export const MANAGED_OWNER_PREDECESSOR_TOKEN_ENV = "WORX_MANAGED_OWNER_PREDECESSOR_TOKEN";
export const MANAGED_OWNER_PREDECESSOR_GENERATION_ENV = "WORX_MANAGED_OWNER_PREDECESSOR_GENERATION";
export const MANAGED_OWNER_PREDECESSOR_RUN_ID_ENV = "WORX_MANAGED_OWNER_PREDECESSOR_RUN_ID";
export const MANAGED_OWNER_PREDECESSOR_INCARNATION_ENV = "WORX_MANAGED_OWNER_PREDECESSOR_INCARNATION";
export const MANAGED_OWNER_TRANSCRIPT_PATH_ENV = "WORX_MANAGED_OWNER_TRANSCRIPT_PATH";
