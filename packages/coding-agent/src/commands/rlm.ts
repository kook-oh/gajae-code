/**
 * `worx rlm` — opt-in Jupyter-style research session with a persistent Python kernel.
 */
...
export default class Rlm extends Command {
	...
	static examples = [
		...
		'# Seed the session with an initial question\n  worx rlm "What drives the spike in the orders table?"',
		"# Point the session at a data description\n  worx rlm --data ./datasets/DATA.md",
	];
