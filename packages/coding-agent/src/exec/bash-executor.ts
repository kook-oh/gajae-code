...
type NativeShellBindings = Pick<typeof import("@bworx-io/worx-code-natives"), "Shell">;
let nativeShellBindingsLoad: Promise<NativeShellBindings> | undefined;

async function shellNatives(): Promise<NativeShellBindings> {
	nativeShellBindingsLoad ??= Promise.resolve(require("@bworx-io/worx-code-natives") as NativeShellBindings);
