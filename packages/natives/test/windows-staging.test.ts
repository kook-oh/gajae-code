 ...
 * `node_modules/@bworx-io/worx-code-natives/native/pi_natives.win32-x64.node` during
 ...
 *      (per-package-version cache under `~/.worx/natives/<version>/`) so the
...
const posixNodeModulesNativeDir = "/home/u/proj/node_modules/@bworx-io/worx-code-natives/native";
...
describe("windows native addon staging", () => {
	...
	it("prepends versionedDir candidates ahead of node_modules when staging on Windows", () => {
		const versionedDir = "C:\\Users\\Admin\\.worx\\natives\\15.0.1";
	...
	it("falls back to the node_modules-only candidate list when staging is off", () => {
		...
		const versionedDir = "/home/u/.worx/natives/15.0.1";
		const candidates = resolveLoaderCandidates({
