...
const CODEX_DEBUG = $pickflag("WORX_OPENAI_CODE_DEBUG", "PI_CODEX_DEBUG");
...
function isCodexWebSocketEnvEnabled(): boolean {
	return $pickflag("WORX_OPENAI_CODE_WEBSOCKET", "PI_CODEX_WEBSOCKET");
}
...
function getCodexWebSocketRetryBudget(options?: Pick<OpenAICodexResponsesOptions, "streamMaxRetries">): number {
	...
	return parseCodexNonNegativeInteger(
		$env.WORX_OPENAI_CODE_WEBSOCKET_RETRY_BUDGET ?? $env.PI_CODEX_WEBSOCKET_RETRY_BUDGET,
...
function getCodexWebSocketRetryDelayMs(retry: number): number {
	const baseDelay = parseCodexPositiveInteger(
		$env.WORX_OPENAI_CODE_WEBSOCKET_RETRY_DELAY_MS ?? $env.PI_CODEX_WEBSOCKET_RETRY_DELAY_MS,
...
function getCodexWebSocketIdleTimeoutMs(overrideMs?: number): number {
	return (
		...
		parseCodexPositiveInteger(
			$env.WORX_OPENAI_CODE_WEBSOCKET_IDLE_TIMEOUT_MS ?? $env.PI_CODEX_WEBSOCKET_IDLE_TIMEOUT_MS,
