...
import { detectOpenAICompat, resolveOpenAICompat } from "@bworx-io/worx-ai/providers/openai-completions-compat";
import type { Context, Model, Tool } from "@bworx-io/worx-ai/types";
