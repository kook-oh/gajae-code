...
const KEYS = ["WORX_AUTH_NO_BORROW", "PI_AUTH_NO_BORROW"] as const;
...
describe("Perplexity native-app borrowing opt-out", () => {
	...
	it("honors the documented WORX_AUTH_NO_BORROW", () => {
		setOnly({ WORX_AUTH_NO_BORROW: "1" });
