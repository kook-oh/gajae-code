...
const GATEWAY_URL = Bun.env.WORX_E2E_GATEWAY_URL ?? "http://127.0.0.1:4000";
const TOKEN_PATH = path.join(os.homedir(), ".worx", "auth-gateway.token");
...
const MODEL = Bun.env.WORX_E2E_OPENAI_RESPONSES_MODEL ?? "gpt-5.3-codex";
