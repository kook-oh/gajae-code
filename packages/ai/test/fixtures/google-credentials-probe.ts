...
import { resolveAdcCredentialsPathForTest } from "@bworx-io/worx-ai/providers/google-auth";
import { resolveVertexApiKeyForTest } from "@bworx-io/worx-ai/providers/google-vertex";
