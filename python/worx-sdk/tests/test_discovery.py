...
from worx_sdk.discovery import Endpoint, EndpointSelectionError, classify_endpoint, read_session_endpoint, select_live_endpoint
...
def test_selection_fails_closed(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("worx_sdk.discovery.os.kill", fake_kill)
