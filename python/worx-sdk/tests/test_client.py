...
from worx_sdk import SdkClient
from worx_sdk.frames import ActionNeeded, ControlResponse, QueryResponse, parse_frame
from worx_sdk.discovery import Endpoint, EndpointSelectionError
...
def test_explicit_session_selection_fails_closed(
    ...
    monkeypatch.setattr("worx_sdk.client.list_session_endpoints", lambda _repo: [endpoint])
    monkeypatch.setattr("worx_sdk.discovery.os.kill", lambda _pid, _signal: (_ for _ in ()).throw(ProcessLookupError()))
