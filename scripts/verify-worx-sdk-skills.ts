...
const discoverPath = path.join("worx-sdk-discover", "SKILL.md");
const operatePath = path.join("worx-sdk-operate", "SKILL.md");
const authorPath = path.join("worx-sdk-author", "SKILL.md");
const typeScriptPath = path.join("worx-sdk-author", "templates", "direct-sdk.ts");
const pythonPath = path.join("worx-sdk-author", "templates", "direct-sdk.py");
...
gate(
	...
	"scripts/worx-sdk-skills/prompts/operate.md",
);
...
for (const [name, contents, expectedName] of [
	["discover", discover, "worx-sdk-discover"],
	["operate", operate, "worx-sdk-operate"],
	["author", author, "worx-sdk-author"],
] as const) {
...
gate(
	...
	typeScript.includes('@bworx-io/worx-code/sdk') && python.includes("from worx_sdk import") && python.includes("SdkClient"),
