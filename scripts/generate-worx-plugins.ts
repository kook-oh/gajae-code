 ...
 *
 * Usage:
 *   bun scripts/generate-worx-plugins.ts            # write files
 *   bun scripts/generate-worx-plugins.ts --check    # compare complete file set + bytes, exit 1 on drift
 */
...
These files are generated by \`scripts/generate-worx-plugins.ts\` from the
...
export function renderPluginFiles(): Map<string, string> {
	...
	// `codex plugin marketplace add ./plugins` reads this and loads ./worx-code.
	files.set(
