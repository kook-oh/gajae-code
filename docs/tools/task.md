...
6. It resolves the requested agent with `getAgent(...)`, rejects unknown or disabled agents, and enforces parent spawn policy plus `WORX_BLOCKED_AGENT` self-recursion prevention.
