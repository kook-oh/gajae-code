...
- Subprocesses / native bindings
  ...
  - `getWorkProfile(30)` comes from `@bworx-io/worx-code-natives`.
  - CPU profiling uses `node:inspector/promises`; heap snapshots use `Bun.generateHeapSnapshot("v8")`; raw/log viewers sanitize text via `@bworx-io/worx-code-natives`.
