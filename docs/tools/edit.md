...
- Subprocesses / native bindings
  ...
  - `invalidateFsScanAfterWrite()` calls native `invalidateFsScanCache()` from `@bworx-io/worx-code-natives`.
- Session state
