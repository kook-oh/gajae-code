...
2. Managed venv at `~/.worx/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.worx/python-env`. `gjc setup python --check` reports the resolved interpreter.
