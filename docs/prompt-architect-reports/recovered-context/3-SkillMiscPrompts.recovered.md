...
- `packages/coding-agent/src/defaults/worx/skills/ralplan/SKILL.md`
- `packages/coding-agent/src/defaults/worx/skills/team/SKILL.md`
- `packages/coding-agent/src/defaults/worx/skills/ultragoal/SKILL.md`
- `packages/coding-agent/src/defaults/worx/skills/deep-interview/SKILL.md`
- `packages/coding-agent/src/defaults/worx/skills/team/SKILL.md:300-449`
- `packages/coding-agent/src/defaults/worx/skills/ultragoal/SKILL.md:300-360`
...
- `packages/coding-agent/src/extensibility/worx-plugins/prompt-appendix.ts`
...
- `packages/coding-agent/src/extensibility/worx-plugins/prompt-appendix.ts:raw`
- `packages/coding-agent/src/defaults/worx/skills/deep-interview/SKILL.md:300-650`
- `packages/coding-agent/src/defaults/worx/skills/deep-interview/SKILL.md:654-952`
...
- `packages/coding-agent/src/worx-runtime/state-runtime.ts:1540-1700`
- `packages/coding-agent/src/skill-state/initial-phase.ts:raw`
- `packages/coding-agent/src/prompts/tools/skill.md`
- `packages/coding-agent/src/worx-runtime/deep-interview-runtime.ts:600-680`
- `packages/coding-agent/src/tools/ask.ts:1-120`
- `packages/coding-agent/src/defaults/worx/skills/ultragoal/SKILL.md:350-360`
...
- `planner-id|planner_resumable|fallback-reason|fallback_reason|artifact-env|stage_n` in `['packages/coding-agent/src/worx-runtime/ralplan-runtime.ts', 'packages/coding-agent/src/commands']`
- `--mode|"read"|"write"|"clear"|"contract"|"doctor"` in `['packages/coding-agent/src/worx-runtime/state-runtime.ts']`
...
- `## Behavior|## Planning/Execution Boundary|## What This Skill Must Do|## GPT-5.5 Guidance Alignment|Follow the Plan skill|the next the|`execution`, `execution`` in `['packages/coding-agent/src/defaults/worx/skills']`
...
- `read-teaming|e2e/read|oh-my-codex` in `['packages/coding-agent/src/defaults/worx/skills']`
- `expandPromptTemplate` in `['packages/coding-agent/src']`
- `topLevelTags` in `['packages/utils/src/prompt.ts']`
- `post-interview|"adr"|KNOWN_STAGES|STAGE_TYPES|StageType` in `['packages/coding-agent/src/worx-runtime/ralplan-runtime.ts']`
- `workflowGate|kind: "approval"|"ralplan".*approval` in `['packages/coding-agent/src/tools', 'packages/coding-agent/src/worx-runtime']`
- `frontmatter\.(level|pipeline|handoff)|\["level"\]|\['level'\]|"pipeline"` in `['packages/coding-agent/src']`
- `skill-fragments|skill-fragment|ai-slop-cleaner` in `['packages/coding-agent/src/defaults/worx/skills', 'packages/coding-agent/src/extensibility']`
- `resolution|quick|standard|deep(?!-interview)` in `['packages/coding-agent/src/worx-runtime/deep-interview-runtime.ts']`
- `--quick|--standard|--deep |resolution` in `['packages/coding-agent/src/defaults/worx/skills/deep-interview/SKILL.md']`
- `workflowGate|WorkflowGateMeta` in `['packages/coding-agent/src/defaults/worx/skills']`
- `contentHash` in `['packages/coding-agent/src/extensibility/worx-plugins/schema.ts', 'packages/coding-agent/src/extensibility/worx-plugins/types.ts', 'packages/coding-agent/src/extensibility/worx-plugins/registry.ts']`
- `replaceAsciiSymbols|normalizeRfc2119` in `['packages/coding-agent/src', 'packages/utils/src']`
- `contentHash` in `['packages/coding-agent/src/extensibility/worx-plugins']`
- `KNOWN_FALLBACK_REASONS = |process_restart|missing_record` in `['packages/coding-agent/src/worx-runtime/ralplan-runtime.ts']`
- `--stage_n|stage-n|stageN` in `['packages/coding-agent/src/worx-runtime/ralplan-runtime.ts:60-120']`
- `replaceAsciiSymbols:\s*true|normalizeRfc2119:\s*true|renderPhase:\s*"pre-render"|prompt\.format\(` in `['packages']`
- `pause` in `['packages/coding-agent/src/defaults/worx/skills/ultragoal/SKILL.md']`
- `contentHash|sha256` in `['packages/coding-agent/src/extensibility/worx-plugins/schema.ts']`
- `renderPluginAppendices\(` in `['packages/coding-agent/src']`
- `relativePath` in `['packages/coding-agent/src/extensibility/worx-plugins']`
