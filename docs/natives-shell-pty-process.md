...
This document covers the execution/process/terminal primitives in `@bworx-io/worx-code-natives`: `shell`, `pty`, `ps`, and `keys`, using the architecture terms from `docs/natives-architecture.md`.
